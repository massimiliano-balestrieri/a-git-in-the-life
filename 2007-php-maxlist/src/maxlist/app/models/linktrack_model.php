 ...
 *
 * 
 * $Id: linktrack_model.php 323 2007-11-26 18:23:10Z maxbnet $
 * $LastChangedDate: 2007-11-26 18:23:10 +0000 (Mon, 26 Nov 2007) $
 * $LastChangedRevision: 323 $
 * $LastChangedBy: maxbnet $
 * $HeadURL: file:///svn/p/maxlist/code/trunk/maxlist/app/models/linktrack_model.php $
 * 
 * $Author: maxbnet $
...
class LinktrackModel extends ModuleModel{
	
	public function __construct($params = false){
		$this->_name = 'linktrack';
	...
	public function get_clicks($id){
		return $this->_dao->get_clicks($id);
	}
}
