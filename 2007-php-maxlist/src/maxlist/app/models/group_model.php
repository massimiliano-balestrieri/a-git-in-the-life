 ...
 *
 * 
 * $Id: group_model.php 323 2007-11-26 18:23:10Z maxbnet $
 * $LastChangedDate: 2007-11-26 18:23:10 +0000 (Mon, 26 Nov 2007) $
 * $LastChangedRevision: 323 $
 * $LastChangedBy: maxbnet $
 * $HeadURL: file:///svn/p/maxlist/code/trunk/maxlist/app/models/group_model.php $
 * 
 * $Author: maxbnet $
...
class GroupModel extends ModuleModel{
	...
	public function check_unique_name($name){
		$id = $this->_id();
		if($id)
			return $this->_dao->check_unique_name_update($name,$id);
		else
			return $this->_dao->check_unique_name_insert($name);
	}
}