...
class ArchiveController extends ModuleController implements IModuleController{
	...
	public function __construct(){
		...
		$this->_model = new ArchiveModel($this->_params);  
	...
	protected function _listall(){
		$data['archive'] = $this->_model->get_archive();
		$this->tpl = 'archive';
		new ArchiveView($this->_params, $data, $this->_model->errors);
	}
}
