...
class ScaffoldController extends ModuleController implements IModuleController{
	...
	public function __construct(){
		...
		$this->_model = new ScaffoldModel($this->_params);  
	...
	protected function _listall(){
		$this->tpl = 'skels';
		new ScaffoldView($this->_params, $this->_model);	
	}
