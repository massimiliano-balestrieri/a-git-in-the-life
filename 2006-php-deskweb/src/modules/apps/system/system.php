 ...
 * class SystemDeskWeb
 */
class SystemDeskWeb extends WindowDeskWeb {
	/**
	* costruttore setta l'id
	*/
	function SystemDeskWeb($id) {
		$this->setId($id);
	}
	/**
	...
	function init($id_array, $id_sezione) {
		...
		require_once (dirname(__FILE__). "/system_model.php");
		$model = new SystemModelDeskWeb();
		require_once (dirname(__FILE__). "/system_panel.php");
		$panel = new SystemPanelDeskWeb($id_array, $id_sezione, $model);
		return $panel;
	}
}
?>