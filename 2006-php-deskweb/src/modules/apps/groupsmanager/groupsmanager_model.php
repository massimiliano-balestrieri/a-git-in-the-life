...
/**
 * classe GroupsmanagerModelDeskWeb
 */
class GroupsmanagerModelDeskWeb {
	 ...
	 */
	function GroupsmanagerModelDeskWeb() {
		global $request;
		$orderby = null;
		$where = null;
		$limit = null;
		...
		$sql = "select id_group,name_group from ".PREFIX_DB."groups ".$where.$orderby.$limit;
		//echo $sql;
