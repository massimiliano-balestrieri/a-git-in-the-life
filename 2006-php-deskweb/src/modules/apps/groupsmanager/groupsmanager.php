 ...
 */
class GroupsmanagerDeskWeb extends WindowDeskWeb {
	/**
	* costruttore setta l'id
	*/
	function GroupsmanagerDeskWeb($id) {
		$this->setId($id);
	}
	/**
	...
	function init($id_array, $id_sezione) {
		...
		require_once (dirname(__FILE__). "/groupsmanager_model.php");
		$model = new GroupsmanagerModelDeskWeb();
		require_once (dirname(__FILE__). "/groupsmanager_panel.php");
		$panel = new GroupsmanagerPanelDeskWeb($id_array, $id_sezione, $model);
		return $panel;
	}
}
?>