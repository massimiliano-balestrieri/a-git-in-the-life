...
/**
 * classe DWUsersmanagerModelDeskWeb
 */
class DWUsersmanagerModelDeskWeb {

	/**
	 * array dati weblets
	 */
	var $arr_usersmanager = array ();
	/**
	 * numero di record
	 */
	var $num_record;
	 ...
	 */
	function DWUsersmanagerModelDeskWeb() {
		global $request;
		$orderby = null;
		$where = null;
		$limit = null;
		...
		//echo $sql;
		$this->arr_usersmanager = MySqlDao :: getDati($sql);
