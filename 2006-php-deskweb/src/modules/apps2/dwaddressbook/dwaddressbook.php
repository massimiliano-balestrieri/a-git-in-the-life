...
/**
 * class DWAddressbookDeskWeb
 */
class DWAddressbookDeskWeb extends WindowDeskWeb {
	/**
	* costruttore setta l'id
	*/
	function DWAddressbookDeskWeb($id) {
		$this->setId($id);
	}
	/**
	...
	function init($id_array, $id_sezione) {
		...
		require_once (dirname(__FILE__)."/dwaddressbook_model.php");
		$model = new DWAddressbookModelDeskWeb();
		require_once (dirname(__FILE__)."/dwaddressbook_panel.php");
		$panel = new DWAddressbookPanelDeskWeb($id_array, $id_sezione, $model);
		return $panel;
	}
}
?>