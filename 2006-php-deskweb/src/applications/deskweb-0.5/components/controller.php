 ...
 * E' globale perchï¿½ incapsulato in un oggetto si perdono parecchi millisecondi in esecuzioni
...
class ControllerDeskWeb {
	 ...
	 * 
	 * il modello
	 * la vista (che è sempre il desktop in questo tipo di applicazione)
	 * 
	 * 
	 */
